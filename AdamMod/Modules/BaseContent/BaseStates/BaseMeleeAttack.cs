...
namespace AdamMod.Modules.BaseContent.BaseStates
{
    public abstract class BaseMeleeAttack : BaseSkillState, SteppedSkillDef.IStepSetter
    {
        ...
        public override void FixedUpdate()
        {
            ...
            var fireStarted = stopwatch >= duration * attackStartPercentTime;
            var fireEnded = stopwatch >= duration * attackEndPercentTime;
