...
namespace AdamMod.Modules
{
    internal static class Language
    {
        ...
        {
            var path = Path.Combine(Path.GetDirectoryName(AdamPlugin.instance.Info.Location), "Language");
        ...
        public static void PrintOutput(string fileName = "")
        {
            ...
            {
                var path = Path.Combine(Directory.GetParent(AdamPlugin.instance.Info.Location).FullName, "Language", "en", fileName);
