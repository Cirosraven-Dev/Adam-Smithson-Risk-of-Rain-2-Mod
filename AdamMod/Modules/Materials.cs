...
namespace AdamMod.Modules
{
    internal static class Materials
    {
        ...
        public static Material LoadMaterial(this AssetBundle assetBundle, string materialName) => assetBundle.CreateHopooMaterialFromBundle(materialName);
        ...
        public static Material SetHopooMaterial(this Material tempMat) => tempMat.ConvertDefaultShaderToHopoo();
