...
namespace AdamMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            var clonedBody = LegacyResourcesAPI.Load<GameObject>("Prefabs/CharacterBodies/" + bodyInfo.bodyNameToClone + "Body");
            if (!clonedBody)
            {
            ...
            var newBodyPrefab = clonedBody.InstantiateClone(bodyInfo.bodyName);
